Feature: Login
  As user, I want to to be able to login into vytrack under different roles with username and password.
...
#  In my project, I was trying to keep scenarios short
  ...
  Scenario: Verify that warning message is displayed when password is not correct
    Given user is on the login page
    Then user enters "storemanager85" username and "wrong_password" password
